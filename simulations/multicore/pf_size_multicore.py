...
import os
from simulations.full_coupling_LUCOS import simulation

from postprocessing.wheat_postpro import w_postpro 

# Define the range of density values to test
D_values = [0,30,50,100,160,250,350,450]

in_folder = "inputs_legume"
...
if __name__ == '__main__':
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=num_workers) as executor:
        executor.map(run_postprocessings, D_values)
