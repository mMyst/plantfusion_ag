...
def simulation(in_folder, out_folder, simulation_length, write_geo=False, run_postprocessing=False):
    ...
    create_child_folder(out_folder, "caribu")
    create_child_folder(out_folder, "ratp")
    ...
    wheat_default = Wheat_wrapper(
        in_folder=in_folder,
        out_folder=os.path.join(out_folder, "caribu"),
        planter=planter,
        indexer=index_log,
    ...
    wheat_ratp = Wheat_wrapper(
        in_folder=in_folder,
        out_folder=os.path.join(out_folder, "ratp"),
        planter=planter,
        indexer=index_log,
        external_soil_model=False,
        nitrates_uptake_forced=False,
...
if __name__ == "__main__":
    ...
    out_folder = "outputs/cnwheat_ratp_Vs_caribu"
